...
class SarsaAgent(object):
    ...
    def SasaLearning(self, gamma, alpha, max_episode_num):
    ...
    def save(self):
        ...
        Sarsa=np.array(self.SarsaReward)
        np.save('sarsa_0.npy', Sarsa)
...
def main():
    ...
    agent.SasaLearning(gamma=0.9, alpha=0.1, max_episode_num=800)
    #agent.save()
    #agent.save()
